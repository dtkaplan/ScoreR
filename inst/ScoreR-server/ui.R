        ...
        wellPanel(
          tabsetPanel(  
            ...
            tabPanel("Manual Grading",
                     ...
                     actionButton("defaultScoreAllToZero","All -> 0"),
                     actionButton("defaultScore1","0 -> 1"),
                     actionButton("defaultScore2","0 -> 2"),
                     actionButton("defaultScore3","0 -> 3"),
                     actionButton("defaultScore4","0 -> 4"),
