  ...
  checkOne <- observe({
    if( input$save==0 ) {
      ...
      isolate({
        ...
        itemSubmit(val=input$in11,flag="in11",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in12,flag="in12",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in13,flag="in13",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in14,flag="in14",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in15,flag="in15",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in16,flag="in16",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in17,flag="in17",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in18,flag="in18",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in19,flag="in19",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$in20,flag="in20",P=prob,A=assign,who=who,roster=roster)
        ...
        itemSubmit(val=input$MC11,flag="MC11",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC12,flag="MC12",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC13,flag="MC13",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC14,flag="MC14",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC15,flag="MC15",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC16,flag="MC16",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC17,flag="MC17",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC18,flag="MC18",P=prob,A=assign,who=who,roster=roster)
        itemSubmit(val=input$MC19,flag="MC19",P=prob,A=assign,who=who,roster=roster)
